...
const slides: SqueezeSlide[] = [
  {
    ...
    href: "/services/residential-interior-design-projects/",
  ...
  },
  {
    ...
    href: "/services/commercial-interiors-projects/",
...
export default function SqueezeCarouselSection(props: SqueezeCarouselSectionProps) {
  ...
  return (
    <section
      id="featured-spaces"
      className="section w-full overflow-hidden bg-background px-3 py-8 sm:px-4 sm:py-12 md:px-8 md:py-16"
    >
